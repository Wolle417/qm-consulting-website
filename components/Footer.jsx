...
export default function Footer() {
  ...
  const offerLinks = isDE ? [
    { href: '/qm-beratung', label: 'Consulting' },
    { href: '/produkte', label: 'Templates' },
    { href: '/tools', label: 'Tools & Wissen' },
    { href: '/ueber-mich', label: 'Über mich' },
  ] : [
    { href: '/qm-beratung', label: 'Consulting' },
    { href: '/produkte', label: 'Templates' },
    { href: '/tools', label: 'Tools & Knowledge' },
  ...
  return (
    <footer className="py-12 px-6 border-t border-border-dark relative z-10">
      <div className="max-w-[90%] mx-auto px-8">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-border-subtle flex flex-col sm:flex-row items-center justify-between gap-2 text-sm" style={{ color: '#000000' }}>
