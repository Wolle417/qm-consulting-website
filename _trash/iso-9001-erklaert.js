// /pages/qm-wissen/iso-9001-erklaert.js
// ISO 9001 erklärt - Grundlagen-Artikel

import Head from 'next/head';
import Link from 'next/link';
import QMWissenLayout from '@/components/qm-wissen/QMWissenLayout'; // Falls vorhanden, sonst anpassen
import { 
  DefinitionBox, 
  TipBox, 
  InfoBox, 
...
export default function ISO9001Erklaert() {
  return (
    <>
      <Head>
        <title>ISO 9001 erklärt | QCore Consulting</title>
        <meta name="description" content="ISO 9001 verständlich erklärt: Die wichtigste QM-Norm, ihre Anforderungen, die 7 Grundsätze und der Weg zur Zertifizierung." />
      </Head>

      {/* Falls QMWissenLayout existiert, diesen verwenden. Sonst durch eigenes Layout ersetzen */}
      <div className="max-w-4xl mx-auto px-4 py-8">
        
        {/* Header */}
        <div className="mb-8">
          <p className="text-qcore-cyan text-sm mb-2">Grundlagen</p>
          <h1 className="text-3xl font-bold text-gray-100 mb-2">ISO 9001 erklärt</h1>
          <p className="text-gray-400 mb-4">Die wichtigste QM-Norm verstehen</p>
