        ...
        {services.map((service, index) => (
          <section key={index} className="relative py-6">
            <div className="relative z-10 max-w-[90%] mx-auto px-8">
              ...
              <div className="bg-qcore-navy bg-opacity-30 hover:bg-opacity-45 transition-all duration-300 p-8 rounded-lg cursor-default">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white bg-opacity-20 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold mb-4" style={{ color: '#1e293b' }}>
                      {service.stepsLabel || 'Typischer Ablauf'}
                    </h3>
